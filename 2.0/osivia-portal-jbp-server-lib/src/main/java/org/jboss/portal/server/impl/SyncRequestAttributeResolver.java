 ...
 */
public class SyncRequestAttributeResolver implements AttributeResolver
{

   /** . */
   private final HttpServletRequest req;

   public SyncRequestAttributeResolver(HttpServletRequest req)
   {
      if (req == null)
      {
   ...
   public synchronized Object getAttribute(Object attrKey) throws IllegalArgumentException
   {
      if (attrKey == null)
      {
   ...
   public synchronized void setAttribute(Object attrKey, Object attrValue) throws IllegalArgumentException
   {
      if (attrKey == null)
      {
         throw new IllegalArgumentException("No null attribute key accepted");
