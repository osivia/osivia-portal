...
public class MigrationModule3401 extends MigrationModule {
            ...
            if (po instanceof Window) {
                ...
                if (window.getContent() != null) {
                    ...
                    if ("toutatice-portail-cms-nuxeo-viewListPortletInstance".equals(window.getContent().getURI())) {
                        ...
                        if (!"1".equals(window.getDeclaredProperty("osivia.cms.hideMetaDatas")))
                            window.setDeclaredProperty("osivia.metadataDisplay", "on");

                        window.setDeclaredProperty("osivia.cms.hideMetaDatas", null);
                    }
                }
            }
        }
