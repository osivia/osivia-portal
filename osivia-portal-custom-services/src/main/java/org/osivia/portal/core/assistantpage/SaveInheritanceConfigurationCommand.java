...
public class SaveInheritanceConfigurationCommand extends ControllerCommand {
    ...
    /** Action value. */
    public static final String ACTION = "SaveInheritanceConfiguration";
    ...
    public ControllerResponse execute() throws ControllerException {
        ...
        try {
            ...
            if (CMSEditionPageCustomizerInterceptor.checkWritePermission(controllerContext, page)) {
                ...
                this.cmsService.saveInheritanceConfiguration(cmsContext, this.pagePath, this.regionName, RegionInheritance.fromValue(this.inheritance));
