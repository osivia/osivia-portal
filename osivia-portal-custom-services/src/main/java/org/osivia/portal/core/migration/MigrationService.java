...
public class MigrationService implements IMigrationManager {
    ...
    private String MIGRATION_TS_PROP_NAME = "osivia.migration.";
    ...
    private List<MigrationModule> getModulesList() {
        ...
        modules.add(new MigrationModule3401());
        ...
        try {
            ...
            for (MigrationModule module : this.getModulesList()) {
                ...
                if (module.getModuleId() > lastId) {
                    ...
                    if (module.isOnlyOnceModule()) {

                        // This module MUSTNOT BE RUN TWICE !!!
                        String migrationDone = adminPortal.getDeclaredProperty(MIGRATION_TS_PROP_NAME + module.getModuleId());
