...
/**
 * CMS command used when a fragment is duplicated in the page
 */
public class CMSDuplicateFragmentCommand extends ControllerCommand {
    ...
    protected static final Log logger = LogFactory.getLog(CMSDuplicateFragmentCommand.class);
    ...
    public CMSDuplicateFragmentCommand(String pageId, String pagePath, String refURI) {
        this.pageId = pageId;
        this.pagePath = pagePath;
        this.refURI = refURI;
    ...
    public ControllerResponse execute() throws ControllerException {
        ...
        try {
            ...
            getCMSService().duplicateFragment(cmsCtx, pagePath, refURI);
