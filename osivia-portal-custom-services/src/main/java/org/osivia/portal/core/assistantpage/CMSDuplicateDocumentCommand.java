...
/**
 * CMS command used when a document is duplicated
 */
public class CMSDuplicateDocumentCommand extends ControllerCommand {

//    public static final String PUBLISH = "publish";
//    public static final String UNPUBLISH = "unpublish";

    private static final String SUCCESS_MESSAGE_DUPLICATE = "SUCCESS_MESSAGE_DUPLICATE";
    ...
    protected static final Log logger = LogFactory.getLog(CMSDuplicateDocumentCommand.class);
    ...
    public CMSDuplicateDocumentCommand(String pageId, String pagePath) {
        this.pageId = pageId;
        this.pagePath = pagePath;
    ...
    public ControllerResponse execute() throws ControllerException {
        ...
        try {
            ...
            String newPath = getCMSService().duplicatePage(cmsCtx, pagePath);
            
            
            String success = itlzService.getString(SUCCESS_MESSAGE_DUPLICATE, getControllerContext().getServerInvocation().getRequest().getLocale());
...
//            getCMSService().getPortalNavigationItem(cmxCtx, basePath, basePath);
            ...
            CmsCommand redirect = new CmsCommand(null, newPath, null, null, null, null, null, null, null, null, null);
            return context.execute(redirect);
