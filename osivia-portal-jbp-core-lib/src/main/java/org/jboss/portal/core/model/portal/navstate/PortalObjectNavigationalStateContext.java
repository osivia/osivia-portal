...
public class PortalObjectNavigationalStateContext implements NavigationalStateContext
{
   ...
   /** The changes. */
   private Map<NavigationalStateKey, NavigationalStateObjectChange> changes;
   ...
   public void setAttribute(Object attrKey, Object newNS) throws IllegalArgumentException
   {
      ...
      if (change != null)
      {
         if (changes == null)
         {
             // OSIVIA : pb de synchronisation (vus en mode WEB)
            //changes = new LinkedHashMap<NavigationalStateKey, NavigationalStateObjectChange>();
             changes = Collections.synchronizedMap(new LinkedHashMap<NavigationalStateKey, NavigationalStateObjectChange>());
         }
