...
public class ControllerContext extends AbstractInvocationContext
{
   ...
   public ControllerContext(ServerInvocation serverInvocation, Controller controller)
   {
      ...
      addResolver(ControllerCommand.NAVIGATIONAL_STATE_SCOPE, new PortalObjectNavigationalStateContext(this, serverInvocation.getContext().getAttributeResolver(ControllerCommand.PRINCIPAL_SCOPE)));
