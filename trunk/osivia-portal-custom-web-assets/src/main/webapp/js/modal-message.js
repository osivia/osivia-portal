...
DHTML_modalMessage = function()
{
	...
	this.layoutCss = 'common.css';	// Default CSS file
...
DHTML_modalMessage.prototype = {
    ...
    __resizeDivs : function()
    {
    	...
    	this.divs_content.style.top = '100px';
 		...
 		if(this.MSIE){
 			...
 			this.iframe.style.width = '0px';//this.divs_content.style.width;
 			this.iframe.style.height = '0px';//this.divs_content.style.height;
 		}
    ...
    __repositionTransparentDiv : function()
    {
		...
		//var bodyWidth = brSize[0];
		//var bodyHeight = brSize[1];
    	this.divs_transparentDiv.style.width = '100%';//bodyWidth + 'px';
    	this.divs_transparentDiv.style.height = '100%';//bodyHeight + 'px';		
