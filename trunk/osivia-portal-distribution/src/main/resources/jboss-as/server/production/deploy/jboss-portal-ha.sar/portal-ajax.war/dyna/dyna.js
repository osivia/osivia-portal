 ...
 * Copyright 2009, Red Hat Middleware, LLC, and individual                    *ajaxWaitDiv
...
function bilto(event)
{
  ...
  if( Element.up(source,"div.no-ajax-link") != null) {
     return;
  }

     if(source.hasClassName("no-ajax-link") ){
          return
       }
