...
import org.jboss.portal.portlet.impl.info.ContainerModeInfo;
import org.jboss.portal.common.i18n.LocalizedString;
import org.jboss.portal.Mode;
...
public class ContainerInfoBuilder
{
   ...
   private ContainerNavigationInfo buildContainerNavigationInfo(PortletMetaData portletMD)
   {
      ...
      if( publicParameters.get("osivia.cms.path") == null){
          ContainerParameterInfo parameter = new ContainerParameterInfo("osivia.cms.path",new QName("osivia.cms.path"), null,  new LocalizedString(""));
          navigation.addPublicParameter(parameter);
      }
      if( publicParameters.get("osivia.cms.pageScope") == null){    
          ContainerParameterInfo parameter = new ContainerParameterInfo("osivia.cms.pageScope",new QName("osivia.cms.pageScope"), null,  new LocalizedString(""));
          navigation.addPublicParameter(parameter);
      }
      if( publicParameters.get("osivia.cms.itemRelPath") == null){    
       
          ContainerParameterInfo parameter = new ContainerParameterInfo("osivia.cms.itemRelPath",new QName("osivia.cms.itemRelPath"), null,  new LocalizedString(""));
          navigation.addPublicParameter(parameter);
      }
      if( publicParameters.get("osivia.cms.contentPath") == null){    
          ContainerParameterInfo parameter = new ContainerParameterInfo("osivia.cms.contentPath",new QName("osivia.cms.contentPath"), null,  new LocalizedString(""));
          navigation.addPublicParameter(parameter);
      }
      //
      return navigation;
