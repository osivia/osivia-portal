...
/**
 * Cette classe a été modifiée pour prendre en compte un paramètre générique de mis à jour du cache
 */
public class CacheControl
{
   ...
   {
	  int  expirationTime = expirationSecs;
      
      if (System.getProperty("portlets.expirationSecs") != null)
    	  try	{
    		  int cachePortlets = Integer.parseInt(System.getProperty("portlets.expirationSecs"));
    		  expirationTime = cachePortlets;
    	  }catch( Exception e)	{
   	  }
