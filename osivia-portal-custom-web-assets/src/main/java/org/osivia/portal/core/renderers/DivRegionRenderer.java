   ...
   implements RegionRenderer
{
   ...
   public void renderHeader(RendererContext rendererContext, RegionRendererContext rrc) throws RenderException
   {
      ...
      if( "1".equals(rendererContext.getProperty("pia.wizzardMode")))	{
    	  markup.print("<div>");
    	  markup.print("<a href=\"#\" onClick=\""+rendererContext.getProperty("pia.addPortletUrl")+"\"><img src=\"/toutatice-portail-custom-web-assets/images/application_add.png\" border=0/></a>");
    	  markup.print("</div>");            
      }
